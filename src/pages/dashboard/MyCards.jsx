...
import { CreditCard, ShoppingCart, Copy, CheckCircle, Clock, XCircle } from "lucide-react";
    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">View and manage your purchased cards</p>
        </div>
        ...
        <Card className="border-2 border-dashed">
          <CardContent className="flex flex-col items-center justify-center py-16 px-4">
            ...
            <p className="text-lg text-muted-foreground mb-6">Card Not Purchased Yet!</p>
            
            <Card className="w-full max-w-md bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20">
              <CardContent className="p-6">
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-2xl">🔥</span>
                  <h3 className="text-xl font-bold">Premium Card Drop is Live!</h3>
                </div>
                <p className="text-muted-foreground mb-4">
                  Unlock ultra-premium cards with high balance, verified BINs, and top-tier value. Limited stock – act fast!
                </p>
                <Button
          ...
          <Card key={card.id} className="overflow-hidden">
            <div className="relative">
              ...
              <div className="absolute top-2 right-2">
                <span className={`flex items-center gap-1 text-xs px-2 py-1 rounded-full font-semibold ${getStatusColor(card.status)}`}>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      ...
                      size="icon"
                      className="h-6 w-6"
                      onClick={() => handleCopy(card.cardNumber, `card-${card.id}`)}
                    >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-semibold text-green-500">{card.balance}</span>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-semibold">${card.purchasePrice.toFixed(2)}</span>
                </div>
                <div className="flex items-center justify-between">
